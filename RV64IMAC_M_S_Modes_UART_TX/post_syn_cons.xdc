  ...
  set_input_delay  -clock [get_clocks {clk_out1_clk_wiz_0}] -min -add_delay 1.5 [get_ports {i_riscv_top_switches_upper}]
  set_input_delay  -clock [get_clocks {clk_out1_clk_wiz_0}] -max -add_delay 7.5 [get_ports {i_riscv_top_switches_upper}]

  set_input_delay  -clock [get_clocks {clk_out1_clk_wiz_0}] -min -add_delay 1.5 [get_ports {i_riscv_top_switches_lower}]
  set_input_delay  -clock [get_clocks {clk_out1_clk_wiz_0}] -max -add_delay 7.5 [get_ports {i_riscv_top_switches_lower}]

  set_input_delay  -clock [get_clocks {clk_out1_clk_wiz_0}] -min -add_delay 1.5 [get_ports {i_riscv_top_button1}]
  set_input_delay  -clock [get_clocks {clk_out1_clk_wiz_0}] -max -add_delay 7.5 [get_ports {i_riscv_top_button1}]

  set_input_delay  -clock [get_clocks {clk_out1_clk_wiz_0}] -min -add_delay 1.5 [get_ports {i_riscv_top_button2}]
  set_input_delay  -clock [get_clocks {clk_out1_clk_wiz_0}] -max -add_delay 7.5 [get_ports {i_riscv_top_button2}]

  set_input_delay  -clock [get_clocks {clk_out1_clk_wiz_0}] -min -add_delay 1.5 [get_ports {i_riscv_top_button3}]
  set_input_delay  -clock [get_clocks {clk_out1_clk_wiz_0}] -max -add_delay 7.5 [get_ports {i_riscv_top_button3}]
